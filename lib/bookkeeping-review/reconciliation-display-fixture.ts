...
export const RECONCILIATION_LEDGER_DISPLAY_FIXTURE: ReconciliationLedgerDisplayModel = {
  nextActions: [
    ...
    {
      id: 'next-source-upload',
      label: '2026년 1기 세금계산서 추가',
      reason: '원천 자료가 부족해 대조 화면에서 해결할 수 없음',
      priority: 'filing_blocker',
      targetRowId: null,
      targetRoute: '/dashboard/direct-upload?period=2026-q1&source=tax_invoice',
    },
  ],
  taxBlockerSummaries: [
    {
  ...
  rows: [
    ...
    {
      id: 'preview-source-missing',
      periodMode: PERIOD_MODE,
      periodLabel: PERIOD_LABEL,
      source: 'bank',
      transactionDate: '2026-06-10',
      counterparty: '(미수집)',
      description: '세금계산서 원본 없음',
      direction: 'expense',
      amountKrw: 1_100_000,
      taxAmountKrw: 110_000,
      ...
      patternSuggestion: null,
      workPanelConclusion: panelConclusion({
        headline: '해당 기간 세금계산서 자료 없음',
        basisLabel: '자료수집에서 원본 추가 필요',
        primaryAction: 'open_source_collection',
      }),
      blockers: [{ code: 'missing_evidence', label: '원천 세금계산서 미수집' }],
      actions: disabledActions,
    },
  ],
}
...
export const RECONCILIATION_DISPLAY_FIXTURE_ROW_IDS = {
  ...
  sourceCollectionBackLink: 'preview-source-missing',
} as const

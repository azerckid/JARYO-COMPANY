...
export const RECONCILIATION_LEDGER_DISPLAY_FIXTURE: ReconciliationLedgerDisplayModel = {
  ...
  rows: [
    ...
    {
      id: 'preview-duplicate-office-01',
      uploadSessionId: FIXTURE_UPLOAD_SESSION_ID,
      periodMode: PERIOD_MODE,
      periodLabel: PERIOD_LABEL,
      source: 'card',
      ...
      patternSuggestion: null,
      duplicateReview: {
        matchedRowIds: ['preview-duplicate-office-02'],
        basisLabel: '같은 날짜·금액·거래처·적요 2건',
      },
      rowConclusion: rowConclusion({
        headline: '중복 거래인지 확인이 필요합니다.',
        basisLabel: '같은 날짜·금액·거래처·적요 2건',
        primaryAction: 'review_duplicate',
      }),
      blockers: [{ code: 'duplicate_review_required', label: '중복 여부 확인 필요' }],
      actions: disabledActions,
    },
    {
      id: 'preview-duplicate-office-02',
      uploadSessionId: FIXTURE_UPLOAD_SESSION_ID,
      periodMode: PERIOD_MODE,
      periodLabel: PERIOD_LABEL,
      source: 'card',
      ...
      patternSuggestion: null,
      duplicateReview: {
        matchedRowIds: ['preview-duplicate-office-01'],
        basisLabel: '같은 날짜·금액·거래처·적요 2건',
      },
      rowConclusion: rowConclusion({
        headline: '중복 거래인지 확인이 필요합니다.',

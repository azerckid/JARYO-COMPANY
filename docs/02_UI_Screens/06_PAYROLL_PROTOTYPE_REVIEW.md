...
- 원천징수 지급명세서는 급여·지급 하위 원천세·지급명세서 화면으로 연결.
...
- External dependencies: 건강보험 EDI/사회보험 고지내역은 최종 4대보험 공제액 근거로 사용한다. 단, 자동 로그인·자동 스크래핑·공동인증서 저장은 v1 제외이고 사용자가 받은 고지내역을 업로드/수동 입력한다. 원천징수 지급명세서는 급여·지급 하위 화면으로 연결한다. 외부 세무사 흐름은 v1 제외.

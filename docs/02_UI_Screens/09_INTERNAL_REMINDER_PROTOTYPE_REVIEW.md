...
- 업무 영역별 규칙(부가세 마감 D-7/D-3/D-1, 급여·지급·자료수집 일일 요약, 연간신고 수동)을 활성 토글로 관리한다.
...
- Internal dependencies: 자료수집·기장검토·급여·지급·부가세·연간신고의 확인 필요 상태. 수신자는 staff·`employee_profile`에서 파생.

...
- Status: `in_progress` (CUI-3 완료 · CUI-4 Preview 승인 PR #271 · **CUI-4 Pre-Code Brief 초안 검토 대기** · runtime 착수 금지)
...
- Implementation Preconditions:
  ...
  - [ ] CUI-4 Pre-Code Brief: [63](../03_Technical_Specs/63_JC043_CUI4_SEBISEO_UPLOAD_RESULT_CARD_PRE_CODE_BRIEF.md) 오너 승인
- Acceptance Criteria:

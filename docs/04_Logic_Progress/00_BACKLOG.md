...
- Document Sync Check: 2026-07-05 영향 감사 + Slice 1~2c + Slice 3a~3b + Slice 3c-0 + **Slice 3c-1(2026-07-06, company-home read switch, PR #103)** + **Slice 3c-2(2026-07-06, validation/declaration FK, PR #104)** + **Slice 3c-3(2026-07-06, bookkeeping FK, migration 0063)** 구현 완료. **Slice 3c-4(2026-07-06, payroll lineage decision)** 완료. **Slice 3c-4a(2026-07-06, payroll extraction FK, migration 0064, PR #107)** 완료 — dev/prod 0064 머지 전 적용. **Slice 3c-5(2026-07-06, adaptive structuring allowlist decision)** 완료. **Slice 3c downstream FK 이관 종료.** 다음: **Slice 4** schema retirement 준비(allowlist·table rebuild 전략).

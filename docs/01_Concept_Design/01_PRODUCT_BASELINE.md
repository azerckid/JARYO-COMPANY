...
|---|---|---|
| 1 | 높음 (구현 대부분 완료) | UI에서 Path 1·2 동등 노출, 세목 확대 |
| 2 | 높음 (JC-034 착수) | ZIP Export v1 → GIWA 수동 수신 검증 |
...
- **Technical_Specs**: [JC-034 GIWA Handoff Scope Gate](../03_Technical_Specs/34_JC034_GIWA_HANDOFF_PACKAGE_SCOPE_GATE.md) - 사무소 전달 패키지 v1 범위

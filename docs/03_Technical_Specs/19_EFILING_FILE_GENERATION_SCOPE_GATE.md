...
| 원천세 신고서 | 급여/원천 데이터 live, 지방소득세 정합성까지 완료, 월 신고 | 원천세 신고서 파일변환 규격 확보 필요 | **다음 Path 1 후보** |
...
2. Output feeds Path 1 plain download. Path 2 JC-034 ZIP는 Path 1 세목 확대 안정 후 재사용.

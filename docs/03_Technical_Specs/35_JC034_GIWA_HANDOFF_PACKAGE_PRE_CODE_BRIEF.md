...
- UI·문구는 승인된 [08_filing_preparation.html](../02_UI_Screens/previews/08_filing_preparation.html) `#jc-034-handoff-export` 패널을 따른다.
...
1. 신고 준비 허브 `/dashboard/filing-preparation` 내 **Path 2 handoff export 패널** (Preview `#jc-034-handoff-export`)

...
미확인: 전체 신고 비암호화 양식과 2026년 첨부서류 파일 수용 규격·암호 요구 여부
다음: 로그인 화면 또는 국세청 126으로 현재 수용 파일·버전·비암호화 여부 확인
...
도구는 일부 첨부서류 전용이다. Path 1 구현을 시작할 만큼 최신 공식 원본·규격·
비암호화 직접 수용 경로가 완결되지 않았으므로 다음을 하지 않는다.

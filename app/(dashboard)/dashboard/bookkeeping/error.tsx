...
interface BookkeepingReviewErrorProps {
  readonly reset: () => void
}

export default function BookkeepingReviewError({ reset }: BookkeepingReviewErrorProps) {
  return (
    <div className="mx-auto flex min-h-full max-w-3xl flex-col gap-4 bg-company-bg p-6">
      <Card>
        <CardHeader>
          ...
          <CardTitle>분류 큐를 불러오지 못했습니다</CardTitle>
          <CardDescription>
